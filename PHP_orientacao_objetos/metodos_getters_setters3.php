  ...
  class Funcionario {
    ...
    */
    ...
    function resumirCadFunc(){
      return 'Nome:'. $this->__get('nome') .', possui '. $this->__get('numFilhos'). ' filho(s) e seu telefone é '.$this->__get('telefone').' Cargo:'. $this->__get('cargo').' Salario R$:'. $this->__get('salario');   
    }
